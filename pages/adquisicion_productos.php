                       ...
                       if($_SESSION['privilegios'] == "Todos"){
                           echo "
                                ...
                                <li class='treeview active'>
                                    ...
                                    <ul class='treeview-menu'>
                                        <li class='active'><a href='adquisicion_productos.php'><i class='fa fa-angle-double-right'></i> Adquisiciòn de productos</a></li>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Adquisicion de productos </li>
                    </ol>
                </section>
                ...
                <section class="content">
                    ...
                    Adquisicion de productos No se a echo Hola mundo
                </section>
                <!-- /.content -->
            </aside><!-- /.right-side -->
        </div><!-- ./wrapper -->
